...
// TODO: Questo file non riesco a trovare, indagare
...
list<EMRealtimeInputDescriptor*>* EMBeMediaSystemInspector::GetRealtimeAudioInputs()
{
	list<EMRealtimeInputDescriptor*>* opList1 = GetInputs(EM_TYPE_RAW_AUDIO);
	return opList1;
}

list<EMRealtimeInputDescriptor*>* EMBeMediaSystemInspector::GetRealtimeVideoInputs()
{
	list<EMRealtimeInputDescriptor*>* opList2 = GetInputs(EM_TYPE_ANY_VIDEO);
	return opList2;
}

list<EMRealtimeOutputDescriptor*>* EMBeMediaSystemInspector::GetRealtimeAudioOutputs()
{
//	list<EMBeRealtimeOutputDescriptor*>* opList1 = new list<EMBeRealtimeOutputDescriptor*>();
	list<EMRealtimeOutputDescriptor*>* opList1 = GetOutputs(EM_TYPE_RAW_AUDIO);
	return opList1;
}

list<EMRealtimeOutputDescriptor*>* EMBeMediaSystemInspector::GetRealtimeVideoOutputs()
{
//	list<EMBeRealtimeOutputDescriptor*>* opList1 = new list<EMBeRealtimeOutputDescriptor*>();
	list<EMRealtimeOutputDescriptor*>* opList1 = GetOutputs(EM_TYPE_RAW_VIDEO);
	return opList1;
}
...
list<EMBeRealtimeInputDescriptor*>* EMBeMediaSystemInspector::GetInputs(EMMediaType p_eType)
{
	...
	//Checking for digital video inputs
		...
		for(int32 vIndex = 0; vIndex < linOutNumNodes; vIndex++)
		{
			...
			{
				opDescriptor = new EMBeRealtimeInputDescriptor(spOutput);
